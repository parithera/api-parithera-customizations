...
export class ChatService {
    ...
    async updateChatHistory(chat: Chat, response: ResponseData, request: string) {
        const newMessage: Message = new Message();
        newMessage.request = request;
        newMessage.code = response.code;
        newMessage.followup = response.followup;
        newMessage.text = response.text;
        newMessage.JSON = response.JSON;
        newMessage.image = response.image;
        newMessage.agent = response.agent;
